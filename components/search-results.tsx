...
export function SearchResults({
  ...
  return (
    <div
      className={cn(
        'my-4 border rounded-lg overflow-hidden bg-white dark:bg-zinc-900',
        className,
      )}
    >
      ...
      <div className="p-3 border-b">
        <div className="flex items-center gap-1 mb-2">
          ...
          <span className="text-xs text-gray-500 ml-1">(Click to open)</span>
        </div>
              ...
              >
                <div className="flex flex-col">
                  <div className="flex items-center gap-1">
                    <span className="bg-sky-500 text-white text-xs rounded-full size-5 flex items-center justify-center shrink-0">
                      {index + 1}
                    </span>
                  ...
                  <span className="text-gray-500 truncate max-w-[250px] ml-6">
                    {result.url}
                  </span>
                </div>
      ...
      {expanded && safeResults.length > 0 && (
        <div className="max-h-80 overflow-y-auto">
          {safeResults.map((result, index) => (
            <div
              key={index}
              className="p-3 border-b last:border-b-0 hover:bg-gray-50 dark:hover:bg-zinc-800"
            >
              <div className="flex justify-between items-start">
                ...
                >
                  <span className="bg-sky-500 text-white text-xs rounded-full size-5 flex items-center justify-center shrink-0 mr-1">
                    {index + 1}
                  </span>
                  {result.title}
